...
class Somoclu(object):
    ...
    def view_umatrix(self, figsize=None, colormap=cm.Spectral_r,
                     ...
                     labels=None, zoom=None, filename=None,labels_legend=None):
    ...
    def _view_matrix(self, matrix, figsize, colormap, colorbar, bestmatches,
                     bestmatchcolors, labels, zoom, filename,labels_legend):
                ...
                if label is not None:
                    plt.annotate(label, xy=(col, row), xytext=(10, -5),
                                 ...
                                 bbox=dict(boxstyle='round,pad=0.3',
                                           fc='white', alpha=0.6),fontsize='xx-small')
        
            
            
            if labels_legend!=None:
                t="Legenda\n"
                for k,v in labels_legend:
                  t+=str(k)+":"+str(v)+"; "

                plt.text(0, -2, t, bbox={'facecolor': 'white', 'pad': 10})
